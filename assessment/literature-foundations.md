...
## 1. Cognitive Forcing Functions (Buçinca et al., 2021)
...
## 2. Contrastive Explanations (Buçinca et al., 2024)
...
- The profile IS the state representation

---

## 4. Productivity & Leveling Effects (Mollick et al., 2023-2024)

**Key findings**:
- AI users: +40% quality, +26% speed, +12.5% more tasks completed
...
## 5. De-skilling Risk (Multiple sources, 2024-2025)

**Finding**: Clinicians who used AI decision support for 3 months performed WORSE after it was removed than before they started. Skills actively atrophied.
...
## 6. The Intelligence Curse Framework (Drago & Laine, 2025)

**Core thesis**: As AI becomes more capable, powerful actors lose incentive to invest in human workers. The social contract breaks.

**Three pillars**:
1. **Avert**: Reduce catastrophic AI risks that justify centralization
2. **Diffuse**: Distribute AI capabilities broadly, augmenting humans
3. **Democratize**: Strengthen institutions to remain human-anchored

**Key strategies for "Diffuse"**:
- Position humans as CEOs directing AI teams
- Easy model finetuning for individuals and small businesses
...
- Help users direct AI, not be directed by it

---

## 7. Education & Workforce Learning Principles

### Zone of Proximal Development (Vygotsky)
- Learning happens at the edge of current ability
- AI should scaffold just beyond what the user can do alone
...
- AI that takes over → destroys autonomy and competence
- Pro-worker AI that coaches → builds autonomy and competence
...
- "You're getting better at this" > "Here's the answer"
...
- Pure substitution (AI does what humans did)
