# Talent-Augmenting OS: Psychometric Scoring Instrument
...
## Instrument: Pro Worker Assessment Questionnaire (TAOSQ)
...
**Interpretation:**
| ADR Score | Risk Level | TAOS Response |
|-----------|-----------|--------------|
...
**Interpretation:**
| GP Score | Potential | TAOS Response |
|----------|----------|--------------|
...
### Pro Worker Readiness Index (TAOSRI)
...
The four sub-scores determine the TAOS calibration:
