---
name: talent-assess
description: Run a Talent-Augmenting Layer onboarding assessment to build your personalised AI profile. Takes ~15 minutes of conversation. Use when a user wants to create or redo their profile.
allowed-tools:
  - Read
  - Write
  - Glob
